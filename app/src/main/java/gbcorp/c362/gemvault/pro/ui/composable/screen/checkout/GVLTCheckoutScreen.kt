...
fun CheckoutScreen(
    ...
    viewModel: GVLTCheckoutViewModel = koinViewModel(),
    ...
    if (orderState is GVLTDataUiState.Populated) {
        CheckoutDialog(
            order = (orderState as GVLTDataUiState.Populated<GVLTOrderEntity>).data,
...
private fun CheckoutContent(
    ...
    Column(
        ...
        Text(
            text = "Provide your contact details to confirm the vault reservation.",
