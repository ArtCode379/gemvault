...
import gbcorp.c362.gemvault.pro.ui.composable.navigation.AppNavHost
...
@Composable
fun AppRoot(
    viewModel: GMVTAppViewModel = koinViewModel()
) {
    ...
    AppRootContent(
        ...
        isCartNotEmpty = cartPopulatedState is GMVTDataUiState.Populated,
